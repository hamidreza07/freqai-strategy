...
class CombinedBinHClucAndMADV9(IStrategy):
    ...
    # buy_condition_0_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=True, load=True)
...
# +--------+---------+----------+--------------------------+--------------+-------------------------------+-----------------+--------------+-------------------
# ------------+
# |   Best |   Epoch |   Trades |    Win  Draw  Loss  Win% |   Avg profit |                        Profit |    Avg duration |    Objective |           Max 
# Drawdown (Acct) |
# |--------+---------+----------+--------------------------+--------------+-------------------------------+-----------------+--------------+-------------------
# ------------|
# | * Best |    1/40 |       60 |     54     0     6  90.0 |        0.21% |      1322.367 USDT   (13.22%) | 0 days 11:38:00 | -1,322.36672 |       662.266 USDT
# (6.40%) |
# | * Best |    2/40 |       72 |     65     0     7  90.3 |        0.31% |      2449.901 USDT   (24.50%) | 0 days 09:41:00 | -2,449.90107 |       687.146 USDT
# (5.34%) |
