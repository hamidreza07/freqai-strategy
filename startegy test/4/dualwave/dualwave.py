...
class dualwave(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[((dataframe['wave_t1']>dataframe['wave_t1_1h']) & (dataframe['wave_t1_1h']<self.slow_wave_buy.value)), 'wave_buy4'] = 1
        dataframe.loc[((dataframe['wave_t1']<dataframe['wave_t1_1h']) & (dataframe['wave_t1_1h']<self.slow_wave_buy.value)), 'wave_buy4'] = 2
        ...
        dataframe.loc[((dataframe['wave_t1']>dataframe['wave_t1_1h']) & (dataframe['wave_t1_1h']>self.slow_wave_sell.value)), 'wave_sell4'] = 1
        dataframe.loc[((dataframe['wave_t1']<dataframe['wave_t1_1h']) & (dataframe['wave_t1_1h']>self.slow_wave_sell.value)), 'wave_sell4'] = 2
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (dataframe['auto_buy_decision_1h'] >= self.auto_buy_2.value) &
                (dataframe['auto_buy_decision'] >= dataframe['auto_buy_decision'].shift(1)) &
                (dataframe['200_SMA_1h'] > dataframe['200_SMA_1h'].shift(8)) &
        ...
        dataframe.loc[
            (
                ...
                (dataframe['auto_buy_decision_1h'] >= (self.auto_buy_2.value + self.auto_buy_down_2.value)) &
                (dataframe['auto_buy_decision'] >= dataframe['auto_buy_decision'].shift(1)) &
                (dataframe['200_SMA_1h'] > dataframe['200_SMA_1h'].shift(8)) &
                (dataframe['200_SMA'] < dataframe['200_SMA'].shift(1)) &
                (dataframe['volume'] > 0)
        ...
        dataframe.loc[
            (
                ...
                (dataframe['auto_buy_decision_1h'] >= (self.auto_buy_2.value + self.auto_buy_bearzzz_2.value)) &
                (dataframe['auto_buy_decision'] >= dataframe['auto_buy_decision'].shift(1)) &
                (dataframe['200_SMA_1h'] < dataframe['200_SMA_1h'].shift(8)) &
                (dataframe['200_SMA'] > dataframe['200_SMA'].shift(1)) &
                (dataframe['volume'] > 0)
        ...
        dataframe.loc[
            (
                ...
                (dataframe['auto_buy_decision_1h'] >= (self.auto_buy_2.value + self.auto_buy_bearzzz_down_2.value)) &
                (dataframe['auto_buy_decision'] >= dataframe['auto_buy_decision'].shift(1)) &
                (dataframe['200_SMA_1h'] < dataframe['200_SMA_1h'].shift(8)) &
                (dataframe['200_SMA'] < dataframe['200_SMA'].shift(1)) &
                (dataframe['volume'] > 0)
