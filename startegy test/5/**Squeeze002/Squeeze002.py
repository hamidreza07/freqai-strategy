...
class Squeeze002(IStrategy):
    ...
    sell_standard_triggers = CategoricalParameter([True, False], default=True, space="sell")
...
# |--------+---------+----------+--------------------------+--------------+-------------------------------+-----------------+--------------+-------------------------------|
# | * Best |    2/50 |       37 |     23     2    12  62.2 |        0.55% |      2241.373 USDT   (22.41%) | 0 days 16:46:00 | -2,241.37321 |       114.853 USDT    (0.93%) |
