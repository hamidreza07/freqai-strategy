...
class bigshort(IStrategy):
    ...
    def leverage(self, pair: str, current_time: 'datetime', current_rate: float,
                 ...
                 **kwargs) -> float:
        if pair == "ETH/USDT" or pair == "BTC/USDT":
            return 20
    ...
    def custom_stake_amount(self, pair: str, current_time: datetime, current_rate: float,
        ...
        return self.wallets.get_total_stake_amount() / 5
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                # LONG 
                (dataframe["fastk_15m"] > 80) &
                (dataframe["fastd_15m"] > 80) &
                (qtpylib.crossed_below(dataframe['fastk_15m'], dataframe['fastd_15m'])) &
                (dataframe['close'] > dataframe['sma15_15m']) &  # MA above close
                (dataframe['close'] > dataframe['sma50_15m']) &
        ...
        dataframe.loc[
            (
                # SHORT
                # GUARDS  
                (dataframe["fastk_15m"] < 20) &
                (dataframe["fastd_15m"] < 20) &
                (dataframe['macdf'] < 0 ) &
                #(dataframe['close'] < dataframe['sma15_15m']) &  
                #(dataframe['close'] < dataframe['sma50_15m']) &
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (qtpylib.crossed_above(dataframe['fastk_15m'], dataframe['fastd_15m']))
            ),
            'exit_short'] = 1
