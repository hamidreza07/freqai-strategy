...
class WTAI(IStrategy):
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime,
        ...
        if current_profit > -0.02 and trade.nr_of_successful_entries == 1:
            return None

        if current_profit > -0.05 and trade.nr_of_successful_entries == 2:
            return None

        if current_profit > -0.075 and trade.nr_of_successful_entries == 3:
            return None
    ...
    def populate_entry_trend(self, df: DataFrame, metadata: dict) -> DataFrame:
        ...
        df.loc[
            ...
            ['enter_long', 'enter_tag']] = (1, 'TEMA-AI')
